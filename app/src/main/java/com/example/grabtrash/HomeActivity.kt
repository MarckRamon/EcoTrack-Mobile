...
import com.example.grabtrash.ui.pickup.OrderStatusActivity
...
import com.example.grabtrash.databinding.ActivityHomeBinding
            ...
            try {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    val paymentMethod = when (paymentResponse.paymentMethod.uppercase()) {
                        "GCASH" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.GCASH
                        "CASH ON HAND" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.CASH_ON_HAND
                        "CREDIT CARD" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.CREDIT_CARD
                        "PAYMAYA" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.PAYMAYA
                        "GRABPAY" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.GRABPAY
                        "BANK TRANSFER" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.BANK_TRANSFER
                        "OVER THE COUNTER" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.OTC
                        "XENDIT PAYMENT GATEWAY" -> com.example.grabtrash.ui.pickup.model.PaymentMethod.XENDIT_PAYMENT_GATEWAY
                        else -> com.example.grabtrash.ui.pickup.model.PaymentMethod.CASH_ON_HAND // Default fallback
                    }
                    ...
                    val wasteType = try {
                        com.example.grabtrash.ui.pickup.model.WasteType.valueOf(paymentResponse.wasteType?.uppercase() ?: "MIXED")
                    } catch (e: Exception) {
                        Log.e(TAG, "Error parsing waste type: ${paymentResponse.wasteType}", e)
                        com.example.grabtrash.ui.pickup.model.WasteType.MIXED
                    }
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        intent.putExtra("PROOF_IMAGE_URL", paymentResponse.getCustomerProofImageUrl())
