...
class PaymentCallbackActivity : AppCompatActivity() {
     ...
     */
    private fun getUpdatedPaymentMethod(data: android.net.Uri): com.example.grabtrash.ui.pickup.model.PaymentMethod? {
        ...
        return com.example.grabtrash.ui.pickup.model.PaymentMethod.XENDIT_PAYMENT_GATEWAY
    }
}